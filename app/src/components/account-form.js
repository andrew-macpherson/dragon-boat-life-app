			...
			<div className="card">
				...
				<form method="post" onSubmit={this.handelOnSubmit}>
					<div className="form-group">
						...
						<input name="email" className="form-control" type="text" value={this.props.currentUser.firstName} onChange={(event) => this.props.updateValue(event.target.value,'firstName')} />
					</div>
					<div className="form-group">
					...
					<div className="form-group">
						<label>Email</label>
						<input name="email" className="form-control" type="text" value={this.props.currentUser.email} onChange={(event) => this.props.updateValue(event.target.value,'email')} />
					</div>
					<div className="form-group">
